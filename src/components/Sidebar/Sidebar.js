  ...
  return (
    ...
    >
      <FontAwesomeIcon
        icon={faHome}
        color="#99989c"
        className={`fa-icon ${activeIcon === 'home' || hoverIcon === 'home' ? 'active' : ''}`}
      ...
      <FontAwesomeIcon
        icon={faChartSimple}
        color="#99989c"
        className={`fa-icon ${activeIcon === 'chart' || hoverIcon === 'chart' ? 'active' : ''}`}
        style={{ fontSize: '1.5rem' }}
      ...
      <FontAwesomeIcon
        icon={faListCheck}
        color="#99989c"
        className={`fa-icon ${activeIcon === 'list' || hoverIcon === 'list' ? 'active' : ''}`}
        style={{ fontSize: '1.5rem' }}
      ...
      <FontAwesomeIcon
        icon={faWallet}
        color="#99989c"
        className={`fa-icon ${activeIcon === 'wallet' || hoverIcon === 'wallet' ? 'active' : ''}`}
        style={{ fontSize: '1.5rem' }}
      ...
      <FontAwesomeIcon
        icon={faSignOut}
        color="#99989c"
        className={`fa-icon ${activeIcon === 'signout' || hoverIcon === 'signout' ? 'active' : ''}`}
